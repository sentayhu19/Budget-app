...
class Transactions1sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transactions1" do
    assert_difference("Transactions1.count") do
      post transactions1s_url, params: { transactions1: { User_id: @transactions1.User_id, amount: @transactions1.amount, name: @transactions1.name } }
    end
  ...
  test "should update transactions1" do
    patch transactions1_url(@transactions1), params: { transactions1: { User_id: @transactions1.User_id, amount: @transactions1.amount, name: @transactions1.name } }
