...
class CategoriesTransaction1sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categories_transaction1" do
    assert_difference("CategoriesTransaction1.count") do
      post categories_transaction1s_url, params: { categories_transaction1: { categories_id: @categories_transaction1.categories_id, transactions1s_id: @categories_transaction1.transactions1s_id } }
    end
  ...
  test "should update categories_transaction1" do
    patch categories_transaction1_url(@categories_transaction1), params: { categories_transaction1: { categories_id: @categories_transaction1.categories_id, transactions1s_id: @categories_transaction1.transactions1s_id } }
