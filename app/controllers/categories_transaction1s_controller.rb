class CategoriesTransaction1sController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @categories_transaction1.save
        format.html { redirect_to categories_transaction1_url(@categories_transaction1), notice: "Categories transaction1 was successfully created." }
  ...
  def update
    respond_to do |format|
      if @categories_transaction1.update(categories_transaction1_params)
        format.html { redirect_to categories_transaction1_url(@categories_transaction1), notice: "Categories transaction1 was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to categories_transaction1s_url, notice: "Categories transaction1 was successfully destroyed." }
